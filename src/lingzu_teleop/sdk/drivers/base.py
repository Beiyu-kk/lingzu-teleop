...
from lingzu_teleop.sdk.data_types import FirmwareVersion, MotorFeedback, ParamReadResult
from lingzu_teleop.sdk.protocol import MotorType, RunMode
...
def create_can_driver(
    *,
    ...
    if normalized in ("socketcan", "socket", "can"):
        from lingzu_teleop.sdk.drivers.socketcan import RobstrideCanDriver
    ...
    if normalized == "slcan":
        from lingzu_teleop.sdk.drivers.slcan import SlcanCanDriver
